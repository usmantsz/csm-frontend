...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        toggleLocale(state, { payload }) {
            ...
            const isRtl = payload === 'pk' || payload === 'ur';
            state.rtlClass = isRtl ? 'rtl' : 'ltr';
        ...
        setOpenSettingPanel(state, { payload }) {
            state.openSettingPanel = payload === true;
        },

        setPageTitle(state, { payload }) {
            document.title = `${payload} | Commssion Shop`;
        },
    },
});

export const { toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleLocale, toggleSidebar, setOpenSettingPanel, setPageTitle } = themeConfigSlice.actions;
